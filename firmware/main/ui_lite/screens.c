...
void create_screen_home_screen_dual() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        {
            // throttle_not_calibrated_text_1
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.throttle_not_calibrated_text_1 = obj;
            lv_obj_set_pos(obj, 4, -170);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffec0707), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            // skateboard_arc_2
            lv_obj_t *obj = lv_arc_create(parent_obj);
            objects.skateboard_arc_2 = obj;
            lv_obj_set_pos(obj, 85, 220);
            lv_obj_set_size(obj, 70, 90);
            lv_arc_set_value(obj, 0);
            lv_arc_set_bg_start_angle(obj, 250);
            lv_arc_set_bg_end_angle(obj, 150);
...
void create_screens() {
    ...
    create_screen_home_screen_dual();
}
